                    ...
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            ...
                            <ul class="pro-body">
                                ...
                                <li><a href="email_inbox.html" class="dropdown-item"><i class="feather icon-mail"></i> Message</a></li>
                            </ul>
                        </div>
                    </div>
                </li>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div class="d-inline-block align-middle">
                                                <img src="" alt="user image" class="img-radius wid-40 align-top m-r-15">
